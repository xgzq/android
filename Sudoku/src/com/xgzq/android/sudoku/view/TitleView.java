...
import com.xgzq.android.sudoku.tools.DimenUtil;
		...
		if (attrs != null)
		{
			...
			if (mRootLinearLayout != null)
			{
				mBackgroundColor = typedArray.getColor(R.styleable.TitleView_backgroundColor,
						TITLE_VIEW_DEFAULT_BACKGROUND_COLOR);
				mRootLinearLayout.setBackgroundColor(mBackgroundColor);

				mViewHeight = (int) typedArray.getDimension(R.styleable.TitleView_viewHeight,
						DimenUtil.dp2Px(getContext(), TITLE_VIEW_DEFAULT_HEIGHT));
			...
			if (showLeftImg)
			{
				...
				if (mLeftImageButton != null)
				{
					...
					mLeftImgResId = typedArray.getResourceId(R.styleable.TitleView_backImgScr,
			...
			else
			{
				if (mLeftTextView != null)
				{
					...
					mLeftBackText = leftText != null ? leftText
							: getContext().getResources().getString(R.string.view_title_tv_left_text);
					mLeftTextView.setText(mLeftBackText);
					mLeftBackTextSize = typedArray.getDimension(R.styleable.TitleView_backTextSize,
							DimenUtil.dp2Sp(getContext(), TITLE_VIEW_DEFAULT_LEFT_TEXT_SIZE));
					mLeftTextView.setTextSize(mLeftBackTextSize);
					mLeftBackTextColor = typedArray.getColor(R.styleable.TitleView_backTextColor,
							TITLE_VIEW_DEFAULT_LEFT_TEXT_COLOR);
			...
			// 中间视图
			showCenterTitle = typedArray.getBoolean(R.styleable.TitleView_isTitle,
					TITLE_VIEW_DEFAULT_CENTER_TITLE_VISIBLE);
			if (showCenterTitle)
			{
				...
				if (mCenterTextView != null)
				{
					...
					mCenterTitleText = title != null ? title
							: getContext().getResources().getString(R.string.view_title_tv_center_text);
					mCenterTextView.setText(mCenterTitleText);
					mCenterTitleTextSize = typedArray.getDimension(R.styleable.TitleView_titleSize,
							DimenUtil.dp2Sp(getContext(), TITLE_VIEW_DEFAULT_CENTER_TEXT_SIZE));
					mCenterTextView.setTextSize(mCenterTitleTextSize);
					mCenterTitleTextColor = typedArray.getColor(R.styleable.TitleView_titleColor,
							TITLE_VIEW_DEFAULT_CENTER_TEXT_COLOR);
			...
			// 右边视图
			showRightImg = typedArray.getBoolean(R.styleable.TitleView_tipImgVisibility,
					TITLE_VIEW_DEFAULT_RIGHT_IMG_VISIBLE);
			if (showRightImg)
			{
			...
			showRightText = typedArray.getBoolean(R.styleable.TitleView_tipTextVisibility,
					TITLE_VIEW_DEFAULT_RIGHT_TEXT_VISIBLE);
			if (showRightText)
			{
				if (mRightTextView != null)
				{
					...
					mRightTipText = tip != null ? tip
							: getContext().getResources().getString(R.string.view_title_tv_right_text);
					mRightTextView.setText(mRightTipText);
					mRightTipTextSize = typedArray.getDimension(R.styleable.TitleView_tipSize,
							DimenUtil.dp2Sp(getContext(), TITLE_VIEW_DEFAULT_RIGHT_TEXT_SIZE));
					mRightTextView.setTextSize(mRightTipTextSize);
					mRightTipTextColor = typedArray.getColor(R.styleable.TitleView_tipColor,
							TITLE_VIEW_DEFAULT_RIGHT_TEXT_COLOR);
